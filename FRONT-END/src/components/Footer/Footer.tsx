...
import { ColorButton, pages } from "../../utils/Utilities";
...
const Footer = () => {
    return (
        <>
            ...
            <Box sx={{ height: "40vh", backgroundColor: "#FAFAFA", mt: "2rem", px: "50px" }}>
                <Box sx={{ display: "flex", my: "auto", border: "1px solid red", width: "50%" }}>
                    <IconButton sx={{ mr: 1 }}>
                ...
                <hr />
                <Typography variant="caption" sx={{ fontFamily: "Roboto, sans-serif", fontWeight: "light" }}>
                ...
                <IconButton size="small">
                    <Link href="https://www.facebook.com/intertec.io/" color="#000000">
                        <FacebookIcon sx={{ fontSize: { sm: "1rem", md: "2rem", lg: "3rem" } }}></FacebookIcon>
                    </Link>
                </IconButton>
                <IconButton size="small">
                    <Link href="https://www.instagram.com/intertec.io/?hl=en" color="#000000">
                        <InstagramIcon sx={{ fontSize: { sm: "1rem", md: "2rem", lg: "3rem" } }}></InstagramIcon>
                    </Link>
                </IconButton>
                <IconButton size="small">
                    <Link href="https://twitter.com/intertecintl" color="#000000">
                        <TwitterIcon sx={{ fontSize: { sm: "1rem", md: "2rem", lg: "3rem" } }}></TwitterIcon>
                    </Link>
                </IconButton>
            </Box>
        </>
