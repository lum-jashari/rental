...
const cars = [
    ...
    },
    {
        ...
        desc: "The Mercedes-Benz 300 SL (chassis code W 198) is a two-seat sports car which was produced by Mercedes-Benz as a gullwinged coupe.",
...
const MostWanted = () => {
    return (
        <>
            ...
            <Container maxWidth="md" component="main" sx={{ my: "2rem", mx: "auto" }}>
